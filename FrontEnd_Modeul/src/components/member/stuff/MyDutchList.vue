        ...
        <div class="stuff-list" v-for="d in model.list" >
            <div @click="showCalcResultHandler(d)">
                <div class="d-gr li-gr m-t-13px list-cl">
					...
					<div class="li-dday"
						:class="(d.deadlineState == 0)? 'expired' : 
...
.li-gr {
	grid-template-columns: 60px 18px 100px 74px 8px 70px;
